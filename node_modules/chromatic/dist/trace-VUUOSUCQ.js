...
var chunkH3XHZKYD_js = require('./chunk-H3XHZKYD.js');
...
var l=chunkTKGT252T_js.e(chunkX7RBQNLE_js.B());var{STORYBOOK_BASE_DIR:g,STORYBOOK_CONFIG_DIR:u,WEBPACK_STATS_FILE:b}=process.env;async function w(c){let{flags:t,input:f}=(0, l.default)(`
    ...
    `,{argv:c,description:"Trace utility for TurboSnap",flags:{statsFile:{type:"string",alias:"s",default:b||"storybook-static/preview-stats.json"},storybookBaseDir:{type:"string",alias:"b",default:g||"."},storybookConfigDir:{type:"string",alias:"c",default:u||".storybook"},untraced:{type:"string",alias:"u",isMultiple:!0},mode:{type:"string",alias:"m"}}}),d={log:console,options:{storybookBaseDir:t.storybookBaseDir,storybookConfigDir:t.storybookConfigDir,untraced:t.untraced,traceChanged:t.mode||!0},git:{rootPath:await chunkH3XHZKYD_js.v()}},p=await chunkLZXDNZPW_js.a(t.statsFile),e=f.map(o=>o.replace(/^\.\//,"")),i=e.find(o=>chunkH3XHZKYD_js.L(o));if(i)throw new Error(`Unable to trace package manifest file (${i}) as that would require diffing file contents.`);await chunkH3XHZKYD_js.Q(d,p,t.statsFile,e);}

exports.main = w;
//# sourceMappingURL=out.js.map
//# sourceMappingURL=trace-VUUOSUCQ.js.map
