...
var chunkRSCZCHQS_js = require('./chunk-RSCZCHQS.js');
...
function f(e){var s;if(e.message&&(e.message=chunkYIR535JQ_js.e(e.message)),(s=e.exception)!=null&&s.values)for(let[p,n]of e.exception.values.entries())n.value&&(e.exception.values[p].value=chunkYIR535JQ_js.e(n.value));return e}function l(e){if(e.category==="console"){if(e.message==="")return null;e.message&&(e.message=chunkYIR535JQ_js.e(e.message));}return e}chunkRSCZCHQS_js.c({dsn:"https://4fa173db2ef3fb073b8ea153a5466d28@o4504181686599680.ingest.us.sentry.io/4507930289373184",release:"11.20.1",dist:"cli",sampleRate:1,environment:"production",enabled:process.env.DISABLE_ERROR_MONITORING!=="true"&&!0,enableTracing:!1,integrations:[],initialScope:{tags:{version:process.env.npm_package_version,index_url:process.env.CHROMATIC_INDEX_URL}},beforeSend:f,beforeBreadcrumb:l});async function g(e){try{let{code:s}=await chunkRSCZCHQS_js.e({argv:e});process.exitCode=s;}catch(s){chunkRSCZCHQS_js.a(s);}finally{await chunkRSCZCHQS_js.b(2500),process.exit();}}

exports.main = g;
//# sourceMappingURL=out.js.map
//# sourceMappingURL=main-P7T2WZCV.js.map
